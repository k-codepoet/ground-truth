...
| `license` | ⬜️ | 라이선스 정보 |
| `compatibility` | ⬜️ | 환경 요구사항 (1-500자) |
| `metadata` | ⬜️ | 추가 메타데이터 (key-value) |
| `allowed-tools` | ⬜️ | 사전 승인된 도구 목록 (실험적) |

## 작성 원칙 (Progressive Disclosure)
...
- [실전 워크플로우](./workflows.md) - Skill 만들기 예제
