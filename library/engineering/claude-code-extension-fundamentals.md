...
- [ced-plugin-agents-marketplace-fix](./ced-plugin-agents-marketplace-fix.md) - agents 검증 자동화
- [craftify-progressive-disclosure](./craftify-progressive-disclosure.md) - UX 패턴
- [forgify-plugin-review](../ai-automation/forgify-plugin-review.md) - 이 기초를 자동화한 도구 검토
