...
| 3 | library/ | /gemify:library | domain별 분류 저장 |
...
- [facet/polish 모드](draft-facet-polish-mode.md) - /gemify:draft 대화 모드
- [실행 우선 원칙](../ai-automation/execution-first-principle.md) - 완벽보다 동작
